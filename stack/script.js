...
var Game = /** @class */ (function () {
    ...
    Game.prototype.stopGame = function () {
        this.stage.remove(this.newBlocks);
        this.stage.remove(this.placedBlocks);
        this.stage.remove(this.choppedBlocks);
        this.blocks = [];
    };
        


    Game.prototype.swal = function () {
        ...
        Swal.fire({
            ...
            denyButtonText: `Restart or Ranking`,
        }).then((result) => {
            ...
            if (result.isConfirmed) {
                Swal.fire({
                    ...
                    preConfirm: (username) => {
                        // post 요청
                        return fetch(`https://api.rainclouds.xyz/stack_rank?username=${username}&score=${score}`,
                            { method: "POST" })
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        function rank_db() {
                            ...
                            xhr.open("GET", "https://apiy.rainclouds.xyz/stack_rank_db");
