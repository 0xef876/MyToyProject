...
function login() {
    ...
    xhr.open("GET", `https://toy.rainclouds.xyz/login?username=${id}&password=${hash_pw}`);
...
function signup() {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open("POST", `https://toy.rainclouds.xyz/signup?username=${id1}&password=${hash_pw1}&phone=${phone}&name=${name}`);
